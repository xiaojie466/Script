...
const $ = new Env('互助码')
$.zdUrl = 'http://api.turinglabs.net/api/v1/jd/bean/create/olmijoxgmjutywossvjg4a66ldb6cicht7qtnsa/'  // 种豆得豆
$.ncUrl = 'http://api.turinglabs.net/api/v1/jd/farm/create/d02daf008b3a4c33b210e60cf2c078c3/'  // 农场
$.mcUrl = 'http://api.turinglabs.net/api/v1/jd/pet/create/MTE1NDAxNzcwMDAwMDAwMzkxMzQzNzM=/'  // 萌宠
$.ddUrl = 'http://api.turinglabs.net/api/v1/jd/ddfactory/create/T0225KkcRkse9VOCJkmgwaEDfACjVWnYaS5kRrbA/'  // 东东
$.jxUrl = 'http://api.turinglabs.net/api/v1/jd/jxfactory/create/dlyZ0aGYuSR6nLm3TMDJcQ==/'  // 惊喜
$.jdzzUrl = 'https://code.chiang.fun/api/v1/jd/jdzz/create/S5KkcRkse9VOCJkmgwaEDfA/'  // 京东赚赚
